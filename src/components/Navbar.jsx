    ...
    <nav className="bg-white">
      <div className="container mx-2 py-2 flex justify-between items-center">
        ...
        <div className="relative -right-32 flex flex-wrap space-x-4 text-xl mt-4 sm:mt-0">
          ...
          <button className="hidden sm:flex items-center px-5 py-2.5 bg-[#F5F6F3FA] hover:bg-gray-100 text-[#004838] font-semibold rounded-md">
            <PiExportLight className="mr-2 text-xl text-[#004838]" />
            Export
          ...
          {/* Share Button */}
          <button className="flex items-center px-5 py-2.5 bg-[#004838] font-medium rounded-md">
